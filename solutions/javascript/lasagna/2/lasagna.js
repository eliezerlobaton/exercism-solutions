...
const getPreparationTimePerLayer = () => 2;
...
export function remainingMinutesInOven(actualMinutesInOven) {
  return EXPECTED_MINUTES_IN_OVEN - Number(actualMinutesInOven || 0);
}
...
export function preparationTimeInMinutes(numberOfLayers) {
  return Array.from({ length: numberOfLayers }, () =>
    getPreparationTimePerLayer(),
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  ...
  const ovenTime = Number(actualMinutesInOven || 0);
